# 8 × 30-min batch benchmark history — gate evidence for 265ce4a / 965732e / cccaa60
...
| cap 6 + pool 3 | verification pool (265ce4a gate) | 499.0 s | 544.9 s | (preview) | resource gate pass |
...
| cap 6 + pool 6 | widened pool (965732e gate) | 494.4 s | 532.8 s | (preview) | resource gate pass; tail 38.4 s |
| **cap 11 + pool 6** | final (cccaa60 gate) | **277.8 s (2.25×)** | **381.7 s** | **1.64×** | **PASS** (bar 1.5×; projection 350–365 s, +5–9% delta attributed to MP3 loudnorm verifies slowing under 6-wide contention with Swift tails) |
